      ...
      <section className="legal-section">
        <div className="container">
          ...
          <article className="legal-copy">
            ...
            <section id="retencao"><h2>8. Retenção e exclusão</h2><p>Os registros permanecem conforme a necessidade da operação, obrigações legais e decisões da loja. Funções de exclusão exigem permissões e confirmação; alguns eventos mínimos de auditoria podem ser preservados para rastreabilidade. A desinstalação, por si só, não deve ser tratada como substituta de um processo formal de cópia ou exclusão.</p></section>
