...
Base de conferência: aplicativo **Assistência Simplificada 9.1.2**, documentação atual, componentes, regras de domínio, migrações locais e suítes automatizadas verificadas em 26/08/2026.
...
- Afirmações encontradas somente em manuais históricos e não confirmadas na versão 9.1.2.

## Configuração comercial atual

- Produto: Assistência Simplificada.
- Versão anunciada: 9.1.2.
